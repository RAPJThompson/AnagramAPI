...
- Endpoint that identifies words with the most anagrams <---------DONE
- Endpoint that takes a set of words and returns whether or not they are all anagrams of each other <---------DONE
- Endpoint to return all anagram groups of size >= *x* <---------DONE
- Endpoint to delete a word *and all of its anagrams* <---------DONE
